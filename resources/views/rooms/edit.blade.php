...
@section('content')
    ...
    <div class="kt-portlet col-md-12">
        ...
        <form method="POST" action="{{ route('rooms.update',$d->id) }}" class="kt-form kt-form--label-right">
            @method('PATCH')
            @csrf
            <div class="kt-portlet__body col-md-9">
                ...
                <div class="kt-portlet__body col-md-9">
                    <div class="form-group row form-group-marginless kt-margin-t-20">
                        ...
                        <label class="col-lg-4 col-form-label">     Room Representative:</label>
                        <div class="col-lg-7">
