                        ...
                        <div class="kt-portlet__head-toolbar">
                            <div class="kt-portlet__head-wrapper">
                                <div class="kt-portlet__head-actions">
                                    ...
                                    &nbsp;
                                    <a href="/units/create" class="btn btn-brand btn-elevate btn-icon-sm">
                                    ...
                                    <table class="table">
                                        ...
                                        @foreach($data as $d)
                                            <tr role="row" class="even">
                                                ...
                                                <td class="">
                                                    @if($d->deleted)
                                                    <a href="#" class="btn btn-label-info btn-bold btn-icon-h kt-margin-l-10">
                                                        {{    __('messages.activate')}}

                                                    </a>
                                                    @else

                                                        <a href="#" class="btn btn-label-danger btn-bold btn-icon-h kt-margin-l-10">
                                                            {{    __('messages.deactivate')}}

                                                        </a>

                                                    @endif
                                                    <a href="/units/{{$d->id}}/edit" class="btn btn-label-warning btn-bold btn-icon-h kt-margin-l-10">
                                                        {{    __('messages.edit')}}
