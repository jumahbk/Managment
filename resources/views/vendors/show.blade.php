        ...
        <!--begin::Form-->
            ...
            <div class="kt-portlet__body col-md-9">
                <div class="form-group row form-group-marginless kt-margin-t-20">
                    ...
                    <div class="col-lg-3">
                        <input disabled id="englishName" name="englishName" type="text" class="form-control" placeholder="Full name">
                    </div>
                    <label class="col-lg-3 col-form-label">{{    __('messages.arabicName')}}:</label>
                    <div class="col-lg-3">
                        <input disabled id="arabicName" name="arabicName" type="text" class="form-control" placeholder="الاسم العربي">
                    </div>
                ...
                <div class="form-group row form-group-marginless kt-margin-t-20">
                    ...
                    <div class="col-lg-3">
                        <input disabled id="phone" name="phone" type="text" class="form-control" placeholder="Full name">
                    </div>
                    <label class="col-lg-3 col-form-label">{{    __('messages.cr')}}:</label>
                    <div class="col-lg-3">
                        <input disabled id="cr" name="cr" type="text" class="form-control" placeholder="الاسم العربي">
                    </div>
                ...
                <div class="form-group row form-group-marginless kt-margin-t-20">
                    ...
                    <div class="col-lg-3">
                        <input disabled id="contactName" name="contactName" type="text" class="form-control" placeholder="Full name">
                    </div>
                    <label class="col-lg-3 col-form-label">{{    __('messages.mobile')}}:</label>
                    <div class="col-lg-3">
                        <input disabled id="mobile" name="mobile" type="text" class="form-control" placeholder="الاسم العربي">
                    </div>
                ...
                <div class="form-group row form-group-marginless kt-margin-t-20">
                    ...
                    <div class="col-lg-3">
                        <input disabled id="contactName2" name="contactName2" type="text" class="form-control" placeholder="Full name">
                    </div>
                    <label class="col-lg-3 col-form-label">{{    __('messages.mobile2')}}:</label>
                    <div class="col-lg-3">
                        <input disabled id="mobile2" name="mobile2" type="text" class="form-control" placeholder="الاسم العربي">
                    </div>
