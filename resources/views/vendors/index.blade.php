                        ...
                        <div class="kt-portlet__head-toolbar">
                            <div class="kt-portlet__head-wrapper">
                                <div class="kt-portlet__head-actions">
                                    ...
                                    &nbsp;
                                    <a href="/vendors/create" class="btn btn-brand btn-elevate btn-icon-sm">
                                    ...
                                    <table class="table">
                                        ...
                                        @foreach($data as $d)
                                            <tr role="row" class="even">
                                                ...
                                                <td class=""><b><a href="/vendors/{{$d->id}}/show">{{$d->englishName}}</a></b></td>
                                                <td class=""><b><a href="/vendors/{{$d->id}}/show">{{$d->arabicName}}</a></b></td>
                                                <td class=""><b><a href="/vendors/{{$d->id}}/show">{{$d->contactName}}</a></b></td>
                                                <td class=""><b><a href="/vendors/{{$d->id}}/show">{{$d->mobile}}</a></b></td>
                                                <td class="">
                                                    @if($d->deleted == 0)
                                                    ...
                                                    @else
                                                        ...
                                                        <a href="/vendors/{{$d->id}}/activate" class="btn btn-label-info btn-bold btn-icon-h kt-margin-l-10">
                                                            {{    __('messages.activate')}}

                                                        </a>

                                                    @endif
                                                    <a href="/vendors/{{$d->id}}/edit" class="btn btn-label-warning btn-bold btn-icon-h kt-margin-l-10">
                                                        {{    __('messages.edit')}}
