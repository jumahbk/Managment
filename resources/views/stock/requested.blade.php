                    ...
                    <div class="kt-portlet">
                        ...
                        <form class="kt-form kt-form--label-right">
                            <div class="kt-portlet__body">
                                ...
                                <div class="form-group row">
                                    <label for="example-email-input" class="col-2 col-form-label">{{__('messages.exp')}}</label>
                                    <div class="col-10">
                                        <input class="form-control" type="datetime-local" value="{{$stock->expDate}}" id="example-datetime-local-input">
                                    </div>
                                </div>
                                <div class="form-group row">
