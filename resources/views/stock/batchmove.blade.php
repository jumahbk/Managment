                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="table-wrapper-scroll-y my-custom-scrollbar">
                            ...
                            <table class="table table-bordered table-striped mb-0">
                                ...
                                <tbody>
                                <form class="kt-portlet__head kt-portlet__head--lg kt-form kt-form--label-right" method="POST" action="/stock/relocategroup" >
                                    @csrf
                                @foreach($data as $d)
...
@endif
                                    ...
                                    <div class="kt-portlet__head-label col-lg-4">
                                        <h3 class="kt-portlet__head-title pr-2">
                                            Relocate to :
                                        </h3>
