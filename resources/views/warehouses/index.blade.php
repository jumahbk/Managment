                                    ...
                                    <table class="table">
                                        ...
                                        @foreach($data as $d)
                                            <tr role="row" class="even">
                                                ...
                                                <td class="">
                                                    @if($d->deleted == 0)
                                                    <a href="/warehousees/{{$d->id}}/deactivate" class="btn btn-label-danger btn-bold btn-icon-h kt-margin-l-10">
                                                        {{    __('messages.deactivate')}}

                                                    </a>
                                                    @else

                                                        <a href="/warehousees/{{$d->id}}/activate" class="btn btn-label-info btn-bold btn-icon-h kt-margin-l-10">
